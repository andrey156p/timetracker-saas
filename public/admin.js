    ...
    r.billingData.forEach(d => {
        ...
        html += `<tr class="border-b hover:bg-gray-50">
            ...
            <td class="p-2 text-right">
                <button onclick="createInvoice('${d.id}', '${start}', '${end}', ${d.cost}, ${d.activeEmployees}, ${d.totalHours})" class="bg-blue-600 text-white text-xs px-2 py-1 rounded">Выставить счёт</button>
            </td>
        </tr>`;
    });
    html += `</tbody></table></div>`;
    ...
    r.invoices.forEach(inv => {
        ...
        html += `<tr class="border-b hover:bg-gray-50">
            ...
            <td class="p-2 text-center">
                ...
                <button onclick="printInvoice(${inv.id}, '${inv.client.name}', '${start}', '${end}', ${inv.amount}, ${inv.workers || 0}, ${inv.hours || 0})" class="text-gray-600 underline text-xs border border-gray-600 rounded px-2 py-1 hover:bg-gray-50 mx-1" data-i18n="print">Печать</button>
...
function printInvoice(id, clientName, start, end, amount, workers, hours) {
